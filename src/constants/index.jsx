      ...
      children: [
        {
          ...
          description: [
            ...
            "Think of it like having a personal AI tutor and a customizable learning environment—where users can generate AI-powered courses, define custom chapters, difficulty levels, and build their own learning roadmap using YouTube content or uploaded material.",
      ...
      children: [
        {
          ...
          description: [
            ...
            "Think of it like having a live algorithm classroom—where every operation is illustrated on screen, making concepts easier to grasp for students, interview prep, and educators.",
      ...
      children: [
        {
          ...
          description: [
            ...
            "Think of it like having a digital forensic investigator—uncovering where a deepfake started, how it spread, and where it was detected across the internet.",
            "It’s built with advanced AI models and real-time analysis, offering accurate detection, transparent origin tracking, and a modern interface for security experts, journalists, and investigators.",
          ],
        },
        {
          id: 2,
...
const ABOUT_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "Hey! I’m Aftab Madni 👋, a web and android developer who enjoys building sleek, interactive websites that actually work well.",
        "I specialize in JavaScript, React,React-Native, and Next.js—and I love making things feel smooth, fast, and just a little bit delightful.",
